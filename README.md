Gesture Controlled Presentation using OpenCV, Python, and MediaPipe (main2.py is the current working version. After installing the dependencies it should work. Tested on a MacBook M2)
